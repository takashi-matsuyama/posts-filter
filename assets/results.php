      ...
      */
      ...
      foreach ( $taxonomies as $taxonomy ) {
        ...
        foreach ( $parent_terms as $parent_term ) {
          $post_parent_term_name = sanitize_text_field( $_POST[$taxonomy->name] );
          if( $post_parent_term_name === $parent_term->slug ) {
            $main_taxquery = array(
              'taxonomy' => $taxonomy->name,
          ...
          if ( $child_terms ) {
            foreach ( $child_terms as $child_term ) {
              if( $post_parent_term_name === $child_term->slug ) {
                $main_taxquery = array(
                  'taxonomy' => $taxonomy->name,
...
<div class="list-ccc_terms_filter_ajax js-list-filter clearfix">
  ...
  <?php if( shortcode_exists( 'ccc_my_favorite_select_button' ) ) { echo do_shortcode('[ccc_my_favorite_select_button]'); } ?>
